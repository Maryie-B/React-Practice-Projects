...
const Filters = () => {
  const {filters: {text, category, company, min_price, price, max_price, shipping}, clearFilters, updateFilters, all_products } = useFilterContext();
  ...
  console.log('max prcie: ',max_price,'company',  company, 'min price ', min_price, 'price', price,'text', text, 'color: ', color );
  return <Wrapper>
